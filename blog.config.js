...
const BLOG = {
  ...
  // 标签是否按照文章数量倒序排列，文章多的标签排在前。
  TAG_SORT_BY_COUNT: true, 
  
  // 对于名称相同的tag是否区分tag的颜色
  IS_TAG_COLOR_DISTINGUISHED: process.env.NEXT_PUBLIC_IS_TAG_COLOR_DISTINGUISHED === 'true' || true, 

  // 3.14.1版本后，欢迎语在此配置，英文逗号隔开 ,  即可支持多个欢迎语打字效果。
  GREETING_WORDS: process.env.NEXT_PUBLIC_GREETING_WORDS || "WHO'S YOUR DADDY?",


  // 支持Menu 类型，从3.12.0版本起，各主题将逐步支持灵活的二级菜单配置，替代了原来的Page类型，此配置是试验功能、默认关闭。
  CUSTOM_MENU: process.env.NEXT_PUBLIC_CUSTOM_MENU || false, 
  
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'brian liu', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || 'blockchain engineer', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tangly1024.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'blockchain engineer, blog, web3, crypto', // 网站关键词 英文逗号隔开
